...
Week 8: Reading & Writing files PRACTICE

Lloyd Cawthorne 29/10/19

This program reads in the file 'dataPRACTICE.txt' (it must be saved in the same
...
INPUT_FILE = open('week_8_read_and_write_data_practice.txt', 'r')
