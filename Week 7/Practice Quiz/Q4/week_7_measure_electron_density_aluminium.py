...
ATOMIC_WEIGHT = 26.981 #  Silver
DENSITY = 2.7 #  g/cm^3 Silver
...
# def data_removing(bfields_data, voltage_data,
...
def main():
    ...
    print('Electron density = {0:.4g} +/- {1:.3g} electrons/m^3.'.
