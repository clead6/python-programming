# -*- coding: utf-8 -*-
"""
PHYS20161 quiz change in entropy A
...
def  entropy_change_object(mass , initial_temperature , final_temperature ):
    ...
    return (mass * HEAT_CAPACITY * np.log(final_temperature / initial_temperature))
...
def entropy_change_lake (object_mass, inital_temperature, final_temperature):
    ...
    heat_exchange =object_mass* HEAT_CAPACITY * (inital_temperature - final_temperature)
